...
const usePhotoGallery = () => {
  ...
  const imagesModules = useMemo(
    () =>
      import.meta.glob('../../../../../../../Pictures/SELECTED/*.{jpg,png}', {
        eager: true,
      }),
    []
  )
          ...
          new Promise((resolve) => {
            loadImage(
              ...
              (img, data) => {
                ...
                const width = isRotated ? originalHeight : originalWidth
                const height = isRotated ? originalWidth : originalHeight
