...
const HomeEntries = () => {
  ...
  const loading = latestPhotoPostLoading || latestMusicPostLoading || latestBlogPostLoading

  const error = latestPhotoPostError || latestMusicPostError || latestBlogPostError

  if (loading) return <LoadingSpinner />
  if (error) return <CatalogContentError />

  return (
    <div id='home-entrys' className='mx-auto mt-12 flex max-w-[800px] flex-wrap gap-12 pt-6'>
